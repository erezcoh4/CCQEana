...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<discrete_distribution<double> >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<discrete_distribution<double> >", -2, "vector", 457,
                  typeid(vector<discrete_distribution<double> >), DefineBehavior(ptr, ptr),
...
namespace ROOT {
   ...
   static void *new_vectorlEdiscrete_distributionlEdoublegRsPgR(void *p) {
      return  p ? ::new((::ROOT::TOperatorNewHelper*)p) vector<discrete_distribution<double> > : new vector<discrete_distribution<double> >;
   }
   static void *newArray_vectorlEdiscrete_distributionlEdoublegRsPgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::TOperatorNewHelper*)p) vector<discrete_distribution<double> >[nElements] : new vector<discrete_distribution<double> >[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlEdiscrete_distributionlEdoublegRsPgR(void *p) {
