...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::GenieFile*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("GenieFile", "GenieFile.h", 39,
                  typeid(::GenieFile), ::ROOT::Internal::DefineBehavior(ptr, ptr),
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<tripleVertex>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<tripleVertex>", -2, "vector", 477,
                  typeid(vector<tripleVertex>), ::ROOT::Internal::DefineBehavior(ptr, ptr),
...
namespace ROOT {
   ...
   static void *new_vectorlEtripleVertexgR(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<tripleVertex> : new vector<tripleVertex>;
   }
   static void *newArray_vectorlEtripleVertexgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<tripleVertex>[nElements] : new vector<tripleVertex>[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlEtripleVertexgR(void *p) {
...
namespace ROOT {
   static TClass *vectorlEdiscrete_distributionlEdoublegRsPgR_Dictionary();
   static void vectorlEdiscrete_distributionlEdoublegRsPgR_TClassManip(TClass*);
   static void *new_vectorlEdiscrete_distributionlEdoublegRsPgR(void *p = 0);
   static void *newArray_vectorlEdiscrete_distributionlEdoublegRsPgR(Long_t size, void *p);
   static void delete_vectorlEdiscrete_distributionlEdoublegRsPgR(void *p);
   static void deleteArray_vectorlEdiscrete_distributionlEdoublegRsPgR(void *p);
   static void destruct_vectorlEdiscrete_distributionlEdoublegRsPgR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<discrete_distribution<double> >*)
   {
      vector<discrete_distribution<double> > *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(vector<discrete_distribution<double> >));
      static ::ROOT::TGenericClassInfo 
         instance("vector<discrete_distribution<double> >", -2, "vector", 477,
                  typeid(vector<discrete_distribution<double> >), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &vectorlEdiscrete_distributionlEdoublegRsPgR_Dictionary, isa_proxy, 0,
                  sizeof(vector<discrete_distribution<double> >) );
      instance.SetNew(&new_vectorlEdiscrete_distributionlEdoublegRsPgR);
      instance.SetNewArray(&newArray_vectorlEdiscrete_distributionlEdoublegRsPgR);
      instance.SetDelete(&delete_vectorlEdiscrete_distributionlEdoublegRsPgR);
      instance.SetDeleteArray(&deleteArray_vectorlEdiscrete_distributionlEdoublegRsPgR);
      instance.SetDestructor(&destruct_vectorlEdiscrete_distributionlEdoublegRsPgR);
      instance.AdoptCollectionProxyInfo(TCollectionProxyInfo::Generate(TCollectionProxyInfo::Pushback< vector<discrete_distribution<double> > >()));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const vector<discrete_distribution<double> >*)0x0); R__UseDummy(_R__UNIQUE_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *vectorlEdiscrete_distributionlEdoublegRsPgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const vector<discrete_distribution<double> >*)0x0)->GetClass();
      vectorlEdiscrete_distributionlEdoublegRsPgR_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_vectorlEdiscrete_distributionlEdoublegRsPgR(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<discrete_distribution<double> > : new vector<discrete_distribution<double> >;
   }
   static void *newArray_vectorlEdiscrete_distributionlEdoublegRsPgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<discrete_distribution<double> >[nElements] : new vector<discrete_distribution<double> >[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlEdiscrete_distributionlEdoublegRsPgR(void *p) {
      delete ((vector<discrete_distribution<double> >*)p);
   }
   static void deleteArray_vectorlEdiscrete_distributionlEdoublegRsPgR(void *p) {
      delete [] ((vector<discrete_distribution<double> >*)p);
   }
   static void destruct_vectorlEdiscrete_distributionlEdoublegRsPgR(void *p) {
      typedef vector<discrete_distribution<double> > current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class vector<discrete_distribution<double> >
